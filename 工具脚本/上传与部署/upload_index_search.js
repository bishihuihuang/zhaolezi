...
// 瑕佷笂浼犵殑鏂囦欢
const FILES = ['index.html', '鏂囦欢鎼滅储.html'];
...
async function main() {
    try {
        console.log('========== 涓婁紶 index.html 鍜?鏂囦欢鎼滅储.html ==========\n');
        ...
        const newCommit = await apiRequest('POST', `/repos/${OWNER}/${REPO}/git/commits`, {
            message: 'Upload index.html and 鏂囦欢鎼滅储.html (user updated content, no modifications)',
            tree: newTree.sha,
        ...
        console.log(`\n璇存槑: 瀹屾暣涓婁紶锛屾湭鍋氫换浣曚慨鏀癸紙涓嶆贩娣嗐€佷笉缇庡寲锛塦);
        console.log(`GitHub Pages灏嗗湪1-2鍒嗛挓鍐呴噸鏂版瀯寤恒€俙);
